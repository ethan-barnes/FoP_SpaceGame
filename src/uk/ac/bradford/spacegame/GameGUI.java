 ...
 * display the game grid, players, asteroids and aliens. The GameGUI class
 * passes keyboard events to a registered InputHandler to be handled.
 *
 * @author prtrundl
 */
public class GameGUI extends JFrame {
     ...
     * elements, specifically the display height and width of tiles in the level
     * and the height of health bars for Ship objects in the game. Tile sizes
     ...
     * entities have moved when a keyboard event was handled. The method
     * requires four arguments and displays corresponding information on the
     * screen.
     *
     ...
     * the right tile and display its health. null can be passed for this
     * argument, in which case no player will be drawn.
     * @param aliens An array of Alien objects that is processed to draw aliens
     * in tiles with a health bar. null can be passed for this argument in which
     * case no aliens will be drawn. Elements in the aliens array can also be
     * null, in which case nothing will be drawn for that element of the array.
     * @param asteroids An array of Asteroid objects that is processed to draw
     * the asteroids on the map. null elements in the array, or a null array are
     * both permitted, and any null arrays or null elements in the array will be
     * skipped.
     */
